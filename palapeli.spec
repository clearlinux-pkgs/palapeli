...
Source0  : https://download.kde.org/stable/release-service/22.04.0/src/palapeli-22.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.0/src/palapeli-22.04.0.tar.xz.sig
...
%prep
%setup -q -n palapeli-22.04.0
cd %{_builddir}/palapeli-22.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650654558
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/palapeli-22.04.0/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/palapeli/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/palapeli-22.04.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/palapeli/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/palapeli-22.04.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/palapeli/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/palapeli-22.04.0/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/palapeli/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/palapeli-22.04.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/palapeli/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/palapeli-22.04.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/palapeli/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/palapeli-22.04.0/src/pics/LICENSE %{buildroot}/usr/share/package-licenses/palapeli/c27070819e7457aece740e2866204327de9c0080
pushd clr-build
%make_install
popd
%find_lang palapeli
