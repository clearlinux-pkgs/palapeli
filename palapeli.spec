...
Source0  : https://download.kde.org/stable/release-service/21.08.2/src/palapeli-21.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.2/src/palapeli-21.08.2.tar.xz.sig
...
%prep
%setup -q -n palapeli-21.08.2
cd %{_builddir}/palapeli-21.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634320161
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/palapeli-21.08.2/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/palapeli/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/palapeli-21.08.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/palapeli/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/palapeli-21.08.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/palapeli/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/palapeli-21.08.2/src/pics/LICENSE %{buildroot}/usr/share/package-licenses/palapeli/c27070819e7457aece740e2866204327de9c0080
pushd clr-build
%make_install
popd
%find_lang palapeli
