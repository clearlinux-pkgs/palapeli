...
%prep
%setup -q -n palapeli-21.12.1
cd %{_builddir}/palapeli-21.12.1
...
cp %{_builddir}/palapeli-21.12.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/palapeli/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/palapeli-21.12.1/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/palapeli/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/palapeli-21.12.1/src/pics/LICENSE %{buildroot}/usr/share/package-licenses/palapeli/c27070819e7457aece740e2866204327de9c0080
pushd clr-build
%make_install
popd
%find_lang palapeli
