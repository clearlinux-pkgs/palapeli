...
Source0  : https://download.kde.org/stable/release-service/20.04.0/src/palapeli-20.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.0/src/palapeli-20.04.0.tar.xz.sig
...
%prep
%setup -q -n palapeli-20.04.0
cd %{_builddir}/palapeli-20.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587676496
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/palapeli-20.04.0/COPYING %{buildroot}/usr/share/package-licenses/palapeli/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/palapeli-20.04.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/palapeli/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
cp %{_builddir}/palapeli-20.04.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/palapeli/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/palapeli-20.04.0/src/pics/LICENSE %{buildroot}/usr/share/package-licenses/palapeli/c27070819e7457aece740e2866204327de9c0080
pushd clr-build
%make_install
popd
%find_lang palapeli
