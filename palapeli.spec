...
Source0  : https://download.kde.org/stable/release-service/22.12.2/src/palapeli-22.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.2/src/palapeli-22.12.2.tar.xz.sig
...
%prep
%setup -q -n palapeli-22.12.2
cd %{_builddir}/palapeli-22.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675636895
mkdir -p clr-build
pushd clr-build
